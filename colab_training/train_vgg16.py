...
def printAndSaveHistoryToFile(history):
    ...
    json.dump(history_dict,
              open(os.path.join(CHECKPOINT_PATH, "vgg16_history.json"), 'w'))
...
def defineCustomCallbacks():
    log_dir = "/content/gdrive/MyDrive/ColabStuff/xai-deepfake-detection/model_checkpoints/logs/vgg16"
...
# Load checkpoint:
checkpoint_path = os.path.join(CHECKPOINT_PATH, "vgg16_model.h5")
